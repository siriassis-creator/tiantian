...
export interface Flextable3colsData {
  sectionNumber?: string;
  titleZh?: string;
  titleEn?: string;
  contentZh?: string;
  contentEn?: string;
  // หัวข้อตารางที่แก้ได้อิสระ
  header1?: string;
  header2?: string;
  header3?: string;
  // ข้อมูลในแถว
...
interface Props {
  data: Flextable3colsData;
  onUpdateNote?: (newNote: string) => void;
}

export default function PatternFlextable3cols({ data, onUpdateNote }: Props) {
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-slate-50 text-slate-500 text-[17px]">
                  <th className="border border-slate-200 p-4 font-normal text-center w-1/3">
